...
namespace eHandel
{
    class ProductManager
    {
        ...
        public Product[] BasicProducts()
        {
            ...
            ArrayOfProducts[1] = new Product(2, "Air Max Pro X", "Mycket snygga skor.", 1299.00, 0);
            ArrayOfProducts[2] = new Product(3, "G-Star Warp", "Stiliga och fina byxor.", 1899.00, 0);
            ArrayOfProducts[3] = new Product(4, "Hilfiger Star", "Supersnygg T-shirt.", 1099.00, 0);
